...
const RideOptionsCard = () => {
    ...
    const createTwoButtonAlert = (title) =>{
        Alert.alert(
            "Your ride request received! 🚗",
            "Thank you for riding with Uber. You will receive a confirmation shortly!",
            [
                {
                text: "Cancel",
    ...
    return (
        <SafeAreaView style={tw`bg-white flex-1`}>
            ...
            <View style={tw`mt-auto border-t border-gray-200`}>
                ...
                >
                    <Text style={tw`text-center text-white text-xl`} onPress={createTwoButtonAlert}>
